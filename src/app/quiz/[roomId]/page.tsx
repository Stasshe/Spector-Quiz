...
export default function QuizRoomPage() {
  ...
  const { quizRoom, isLeader, currentQuiz } = useQuiz();
  ...
  // 解答権を持っているかどうかを確認
  const hasAnswerRight = currentUser && quizRoom.currentState.currentAnswerer === currentUser.uid;
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            {quizRoom.status === 'in_progress' && (
              <div>
                ...
                {/* 解答入力（解答権を持っている場合） */}
                {hasAnswerRight && quizRoom.currentState.answerStatus === 'answering' && (
                  <AnswerInput
                    quiz={currentQuiz}
