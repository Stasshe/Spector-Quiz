...
// サービス関数をインポート
import {
  fetchAvailableRooms as fetchRoomsService,
  checkAndDisbandOldRooms as checkOldRoomsService,
  getUnitIdByName as getUnitIdService,
  createUnitIfNotExists as createUnitService,
  updateUserStatsOnRoomComplete as updateStatsService,
  calculateRank,
  getRoomById,
  createRoomService,
...
// サービス関数をインポート
import {
  fetchAvailableRooms as fetchRooms,
  checkAndDisbandOldRooms as checkOldRooms,
  getUnitIdByName as getUnitId,
  createUnitIfNotExists as createUnit,
  updateUserStatsOnRoomComplete as updateUserStats,
  createRoomService,
  createRoomWithUnitService,
  joinRoomService,
  leaveRoomService,
